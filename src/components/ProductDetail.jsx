    ...
    <div className='row'>
      ...
      <div className='col-md-6'>
        ...
        <div className='product-info'>
          <div className='product.title'>{thisProduct.title}</div>
        </div>
      ...
      />
        ...
        <NavLink to="#"
           > 
        <button className='btn btn-outline col-12  border-0 p-3 ' onClick={() => handleCart(thisProduct)}>
          {cartBtn}</button></NavLink>
        </>
        ) }
      </div>
    </div>
      ...
      <div className='col-md-6'>
        ...
        <div className='mb-5 mb-mb-3 bg-light p-3 shadow-sm rounded'>
          ...
          <div className='alert alert-info mt-3'>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptas rem ratione consequuntur sapiente alias enim, natus molestiae suscipit quaerat ipsam animi nemo, 
            placeat in hic quam ullam neque ad libero.
          </div>
        </div>
      </div>
      <div className='col-md-6'>
        ...
        <form>
          ...
          <div className='my-4'>
            ...
            <textarea row="3" className='col-12 bg-light p-3 mt-2 border-0 rounded'>
            </textarea>
          </div>
          <div className='my-3'>
