...
import {
    USER_DETAILS_FAIL, USER_DETAILS_REQUEST, USER_DETAILS_RESET, USER_DETAILS_SUCCESS, USER_LOGIN_FAIL, USER_LOGIN_REQUEST,
...
export const login = (email, password) => async (dispatch) => {
    ...
    try {
        ...
        //     toast.error("tu n'est pas admin",ToastObjects);
        //     dispatch({
